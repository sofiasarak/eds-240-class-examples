...
base_map <- ggplot(joined_precip_geom) +
  ...
  labs(title = "5-year precipitation compared with the 20th century average",
       subtitle = "January 2020 to December 2024",
...
classed: statistical patterns
unclassed: most exact representation, allows you to see subtle differences
...
#| echo: true
# preview palette ----
RColorBrewer::display.brewer.pal(n = 11, name = 'BrBG') # pick 11 colors from this color palette
